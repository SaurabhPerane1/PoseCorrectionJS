...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    if (leftElbowAngle < 45) {
      ...
      canvasCtx.fillText('Now, Pull Down', leftElbowPos.x, leftElbowPos.y - 10);
    }
    else if (leftElbowAngle > 160) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Pull Yourself Up', leftElbowPos.x, leftElbowPos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
    ...
    if (rightElbowAngle < 45) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Now, Pull Down', rightElbowPos.x, rightElbowPos.y - 10);
    }
    else if (rightElbowAngle > 160) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Pull Yourself Up', rightElbowPos.x, rightElbowPos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
