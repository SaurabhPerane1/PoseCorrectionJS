...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    if (leftKneeAngle < 80) {
      ...
      canvasCtx.fillText('Now Push Knees Up', leftKneePos.x, leftKneePos.y - 10);
    }
    else if (leftKneeAngle > 150) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Push Knee Down', leftKneePos.x, leftKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
    ...
    else if (rightKneeAngle > 150) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Push Knee Down', rightKneePos.x, rightKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
