...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    else if (leftElbowAngle > 150) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Pull Yourself Down', leftElbowPos.x, leftElbowPos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
    ...
    else if (rightElbowAngle > 150) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Pull Yourself Down', rightElbowPos.x, rightElbowPos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
