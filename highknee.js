...
function onResults(results) {
  ...
  if (results.poseLandmarks) {
    ...
    if (leftKneeAngle < 80) {
      ...
      canvasCtx.fillText('Now Push Knees Down', leftKneePos.x, leftKneePos.y - 10);
    }
    else if (leftKneeAngle > 160) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Push Knee Up', leftKneePos.x, leftKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
    ...
    if (rightKneeAngle < 80) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Now Push Knees Down', rightKneePos.x, rightKneePos.y - 10);
    }
    else if (rightKneeAngle > 160) {
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
      canvasCtx.fillText('Ok, Now Push Knee Up', rightKneePos.x, rightKneePos.y - 10);
    }
    else{
      canvasCtx.fillStyle = 'lime';
      canvasCtx.font = '30px Arial';
